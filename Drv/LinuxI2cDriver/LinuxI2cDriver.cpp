...
void LinuxI2cDriver ::init(const NATIVE_INT_TYPE instance) {
...
Drv::I2cStatus LinuxI2cDriver ::write_handler(const NATIVE_INT_TYPE portNum, U32 addr, Fw::Buffer& serBuffer) {
...
Drv::I2cStatus LinuxI2cDriver ::read_handler(const NATIVE_INT_TYPE portNum, U32 addr, Fw::Buffer& serBuffer) {
    // Make sure file has been opened
    if (-1 == this->m_fd) {
        return I2cStatus::I2C_OPEN_ERR;
    }
...
Drv::I2cStatus LinuxI2cDriver ::writeRead_handler(const NATIVE_INT_TYPE portNum, /*!< The port number*/
                                                  U32 addr,
    ...
    struct i2c_msg rdwr_msgs[2] = {{// Start address
